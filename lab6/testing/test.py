...
tests = [
  ("Exercise 1 (Practice with Advanced features) test", "student_output/ex1_test.out",TestCase(os.path.join(file_locations,'circ_files/ex1_test.circ'), os.path.join
(file_locations,'reference_output/ex1_test.out'), "")),
  ("Exercise 2 (Rotate Right) test", "student_output/ex2_test.out",TestCase(os.path.join(file_locations,'circ_files/ex2_test.circ'), os.path.join
(file_locations,'reference_output/ex2_test.out'), "")),
  ("Exercise 3 (Runing LED) test", "student_output/ex3_test.out",TestCase(os.path.join(file_locations,'circ_files/ex3_test.circ'), os.path.join
