...
(file_locations,'reference_output/alu-add-ref.out'), "")),
  ...
  ('ALU sll test', "student_output/alu-sll-student.out", TestCase(os.path.join(file_locations,'alu_tests/alu-sll.circ'), os.path.join(file_locations,'reference_output/alu-sll-ref.out'), "")),
